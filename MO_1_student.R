...
#Zadanie 2
#Zmodyfikuj poni¿szy kod uwzgledniajac 4 progi mandatu 
...
#Zadanie 3 - Liczby Fibonacciego (kolejna liczba jest sum¹ dwóch poprzednich)
...
# Zadanie 6*
#Napisz funkcjê która wypisuje wszystkie liczby pierwsze w zakresie od 0 do n